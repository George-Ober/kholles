...
\begin{question_kholle_remarque}{Montrer que $v \circ u$ surjective implique $v$ surjective + montrer que cela n'implique pas $u$ surjective.}
  {Les deux contre contre-exemples exhibés ici sont les mêmes, mais il y en a bien d'autres où $v \circ u$ n'est pas bijective.}
  Soient $(u, v) \in \mathcal{F}(E, F) \times \mathcal{F}(F, G)$.
