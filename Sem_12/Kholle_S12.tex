...
\usepackage[nb-sem=12, auteurs={Kylian Boyet, Hugo Vangilluwen, George Ober}]{../kholles}
...
\begin{document}
	...
	\end{question_kholle}
	\begin{question_kholle}[L'ensemble des solutions de l'équation $\forall n \in \mathbb{N}, u_{n+1} = au_{n} + v_{n}$
