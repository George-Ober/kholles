...
\begin{question_kholle}
    ...
    Alors la moyenne arithmérique des $n\in \N$ premiers termes converge vers $\ell$.]
    {Théorème de Césarò}
    ...
    \]
    Fixons un tel $N$. Posons $\omega = \sum_{k=0}^{N-1} |u_k - \ell | \in \R$. Soit $n\in \N$ tel que $n \leq N$. Calculons : 
    \[
...
\begin{question_kholle}
    ...
    Posons $\varphi (0) = \min{ \{ k\in \N \ | \ |u_k - \ell| > \varepsilon \} }$, ce qui a du sens car c'est une partie non-vide de $\N$. Posons ensuite $\varphi (1) = \min{ \{ k\in \N \ | \ |u_k - \ell| > \varepsilon, \ \varphi(0) < k \} } $, ce qui a du sens pour les mêmes raisons. On construit on itérant ce procédé $\varphi (n)$ tel que : 
    \[
