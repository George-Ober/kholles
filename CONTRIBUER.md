...
- Pour les flemmards, \fq pour 'fixé quelconque', \fqs pour 'fixés quelconques', \tq pour 'tel que' et \tqs pour '\tels que', \sev pour 'sous-espace vectoriel', \sevs au pluriel (et \bda pour \lambda)
