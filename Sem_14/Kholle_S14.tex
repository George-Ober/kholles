...
\begin{document}
	...
	\begin{question_kholle}
		...
		\begin{itemize}[label=$\star$]
			\item $\zeta_{]-\infty;0[}$ est constante donc $\zeta \in \Cont{\infty}{]0;-\infty[}{}$.
			\item $x \mapsto - \frac{1}{x} \in \mathcal{C}^\infty(]0;-\infty[,\R)$ et $\exp \in \Cont{\infty}{]0;-\infty[}{}$ donc, par stabilité de \Cont{\infty}{}{} par composition, $\zeta \in \Cont{\infty}{]0;-\infty[}{}$.
		\end{itemize}
		...
		\begin{itemize}[label=$\star$]
			...
			\begin{itemize}[label=$\star$]
				...
				\begin{itemize}[label=$\star\star$]
					...
					Le théorème des croissances comparées donne $u^{2k} P_k(\frac{1}{u}) \e^{-\frac{1}{x}} \arrowlim{x}{0^+} 0$ donc $\zeta^{(k)} = 0$.
				\end{itemize}
			\end{itemize}
