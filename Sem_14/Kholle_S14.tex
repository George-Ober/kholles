...
\begin{document}
	...
	\begin{question_kholle}
		...
		\begin{itemize}[label=$\star$]
			...
			\item $x \mapsto - \frac{1}{x} \in \mathcal{C}^\infty(]0;+\infty[,]-\infty;0[)$ et $\exp \in \Cont{\infty}{]-\infty;0[}{}$ donc, par stabilité de \Cont{\infty}{}{} par composition, $\zeta \in \Cont{\infty}{]-\infty;0[}{}$.
		\end{itemize}
