...
\begin{question_kholle}{Condition nécéssaire et suffisante de convergence de $\sum_{n\geqslant 0}q^{n}$ pour $q \in \mathbb{C}^{*}$ et calcul de la somme et du reste lorsqu'ils existent.}
    ...
    \end{itemize}
\end{question_kholle}
\begin{question_kholle}[{Soit $\alpha \in \mathbb{R}$
...
\begin{question_kholle}{Comparaison série-intégrale}
    ...
    D'où l'encadrement.
\end{question_kholle}
\begin{question_kholle}[{Soit $n_{0} \in \mathbb{N}$ et $f:[n_{0}, +\infty[ \to \mathbb{R}$ une fonction continue, décroissante et minorée par $m \in \mathbb{R}$
...
$$
    ...
    \end{itemize}
\end{question_kholle}
\begin{question_kholle}[{Soit $u \in \mathbb{K}^{[ \! [ n_{0}, +\infty [ \![}$
