...
\begin{document}
	...
	\begin{question_kholle}
		{$\mathbb{Q}$ est dense dans \R et $\R \setminus \mathbb{Q}$ est aussi dense dans \R}
		...
		\end{itemize}
		Donc d'après la caractérisation séquentielle de la densité, $\mathbb{Q}$ est dense dans \R.
		\bigbreak
		...
		\begin{itemize}
			...
			\end{equation*}
		\end{itemize}
		Donc d'après la caractérisation séquentielle de la densité, $\R\setminus \mathbb{Q}$ est dense dans \R.
	\end{question_kholle}
	...
	\begin{question_kholle}[Le titre se suffit à lui-même]{Une suite convergente est bornée}
